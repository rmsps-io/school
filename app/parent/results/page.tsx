...
export default async function ParentResultsPage() {
  ...
  results?.forEach(r => {
    const en = (r.exams as {name:string}[]|null)?.[0]?.name ?? 'Others'
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-display font-semibold">Child&apos;s Results</h2>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant={overallPct >= 33 ? 'success' : 'destructive'} className="text-[10px]">{overallPct}%</Badge>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
